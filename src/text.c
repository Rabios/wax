...
const char* TEXT_std_ruby = "def w_trunc(x)\n  if (x > 0) then\n    return x.ceil()\n  else\n    return x.floor()\n  end\nend\n\n"
"def w_arr_remove(x, i, n)\n  (i..(i+n)).each do |j|\n    x.delete(j)\n  end\nend\n\n"
"def w_strfix(s)\n  if s.class == \"Integer\"\n    return s.chr().downcase()\n  end\n  return s\nend\n";
const char* TEXT_std_moon = "w_trunc = (x) ->\n"
"  if x < 0\n"
"    return math.ceil(x)\n"
"  else\n"
"    return math.floor(x)\n\n"
...
"    try:del m[k]\n"
"    except:pass\n";
const char* TEXT_std_coffee = "w_slice = (x, i, n) -> x.slice(x, i+n)\n";
...
"#endif\n";
const char* TEXT_std_kotlin = "public fun <T> w_arrRemove(a: ArrayList<T>, i: Int, n: Int){ a.subList(i,i+n).clear(); }\n"
...
const char* TEXT_std_js = "const w_slice=function(x, i, n) { x.slice(i,i+n); };\n";
